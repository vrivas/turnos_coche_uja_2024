...
var C_INMA_BARROSO = new Persona("Inma B.", "ibarroso@ujaen.es");
var C_INMA_GARCIA = new Persona("Inma Gª", "igmartin@ujaen.es");
...
var C_MIGUEL = new Persona("Miguel", "msantama@ujaen.es"); // MIGUEL SANTAMARÍA, 2025
